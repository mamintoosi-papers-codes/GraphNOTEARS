                ...
                for p_graph_type in p_graph_types:
                    for sem_type in sem_types:
                        ...
                        for times in range(5):
                            ...
                            model_2 = GraphNOTEARS.model_p1_MLP(dims=[d, n, 1], bias=True)
                            model_2.to(device)
                            W_est_2, P1_est_2 = GraphNOTEARS.linear_model(model_1, Xlags_torch, adj1_torch,\
                                                            lambda1 = 0.01, lambda2 = 0.01, rho_p=1)
                        ...
                        for i in range(2):
                            if i == 0:
                                model_name = "model_1 (W): "
                            if i == 1:
                                model_name = "model_2 (WP): "
                            if i == 2:
